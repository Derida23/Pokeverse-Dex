export const menus = [
  ...
  },
  {
    title: 'Pokemon Data',
    menu: [
      { name: 'Evolutions', icon: 'i-lucide-infinity', slug: 'evolutions' },
      { name: 'Types', icon: 'i-lucide-toy-brick', slug: 'types' },
      { name: 'Egg Groups', icon: 'i-lucide-paw-print', slug: 'egg-groups' }
    ]
  }
];
